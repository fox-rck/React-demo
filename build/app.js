...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = __webpack_require__(6); // or var Router = ReactRouter; in browsers
	...
	var routes = (
	  React.createElement(Route, {name: "app", path: "/", handler: App}, 
	  	React.createElement(Route, {name: "contact", path: "/contact", handler: __webpack_require__(3)}), 
	    React.createElement(Route, {name: "proscons", path: "/pro-cons", handler: __webpack_require__(99)}), 
	  	React.createElement(Route, {name: "pills", path: "/pills", handler: __webpack_require__(4)}), 
	  	React.createElement(Route, {name: "test", path: "/test", handler: __webpack_require__(4)}), 
	    React.createElement(DefaultRoute, {handler: __webpack_require__(3)})
	  )
	);
	...
	module.exports = React.createClass({displayName: "module.exports",
	    ...
	    , render: function(){
	        return React.createElement("div", null, 
		        ...
		        React.createElement("div", {className: "tab-wrapper"}, 
	                React.createElement(Link, {className: "btn", to: "contact"}, "Contact"), 
	                React.createElement(Link, {className: "btn", to: "proscons"}, "Pros and Cons"), 
	                React.createElement(Link, {className: "btn", to: "pills"}, "Pills"), 
	                React.createElement(Link, {className: "btn", to: "test"}, "Tests"), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports =
	    ...
	    React.createClass({displayName: "module.exports",
	    ...
	    render: function() {
	        ...
	        var validationError = this.state.errorMsg.length ?
	            ...
	            this.state.errorMsg.map(function(err) 
	                {return React.createElement("div", null, err.errorMsg);}
	            )
	            )
	            : "";
	        return React.createElement("div", {className: contactFormContainer}, 
	                React.createElement("h2", null, "React Contact Form"), 
	                React.createElement("p", null, "This is an example of a React contact form."), 
	                React.createElement("div", {className: contactForm}, 
	                    React.createElement("form", {ref: "form", onSubmit: this.onSubmit}, 
	                        React.createElement("label", null, "Name:"), 
	                        React.createElement("input", {className: inputClasses, ref: "inputboxName", placeholder: "Enter your name", value: value, onChange: this.handleChange}), 
	                        React.createElement("label", null, "Email:"), 
	                        React.createElement("input", {className:  emailRegex.test(emailVal) ? inputClasses : inputValidation, ref: "inputboxEmail", placeholder: "Enter your email", value: emailVal, onChange: this.handleChange, validation: this.props.validation}), 
	                        React.createElement("label", null, "Address:"), 
	                        React.createElement("input", {className: inputClasses, ref: "inputboxAddress", placeholder: "Enter your address", value: addyVal, onChange: this.handleChange}), 
	                        React.createElement("label", null, "State"), 
	                        React.createElement("select", {className: selectClasses, ref: "states", value: this.state.selected, onChange: this.handleChange}, 
	                            this.stateOptions.map(function(opt) 
	                                {return React.createElement("option", {value: opt.value}, opt.label);}
	                            )
	                        ), 
	                        React.createElement("label", null, "Zip Code"), 
	                        React.createElement("input", {className: zipcodeClasses, ref: "inputZip", placeholder: "Zip Code", value: zipcodeVal, onChange: this.handleChange}), 
	                        React.createElement("textarea", {rows: "5", cols: "30", className: inputClasses, ref: "textareaComment", placeholder: "What do you want to say", value: commentVal, onChange: this.handleChange}), 
	                        validationError, 
	                        React.createElement("br", null), 
	                        React.createElement("br", null), 
	                        React.createElement("button", {className:  emailRegex.test(emailVal) && emailVal !== "" && value !== "" && addyVal !== "" && commentVal !== "" && zipcodeVal !== "" ? btnClasses  : btnDisabledClasses, ref: "submitBtn", type: "submit"}, "Submit")
	                    )
	                )
	        )
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */'use strict'
	var React = __webpack_require__(5)
	var TestWorld = React.createClass({displayName: "TestWorld",
	    awesomeFn: function(arg1) {
	        return "123";
	    },
	    render: function() {
	        return (React.createElement("div", null, "TEST WORLD"));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createRouter(options) {
	  ...
	  if (location instanceof StaticLocation) {
	    warning(!canUseDOM || ("dev") === 'test', 'You should not use a static location in a DOM environment because ' + 'the router will not be kept in sync with the current URL');
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  getInitialState: function() {
	                      ...
	                      set.map(function(item ,idx)
	                        {return React.createElement("li", null, 
	                          React.createElement("h4", null, 
	                            item.title, 
	                            React.createElement("a", {onClick: this.seeMore.bind(this, setIdx, idx)},  !item.is_opened ? ' see more' : ' see less')
	                          ), 
	                          React.createElement("span", null, item.is_opened ? item.description : "")
	                        );}.bind(this)
	                      )
	                  )
	              )
	    ...
	    ,render: function() {
	      return (
	        React.createElement("div", {className: "pros-cons-wrapper"}, 
	          React.createElement("h2", null, "ReactJS Pros/Cons"), 
	          [0,1].map(function(x)
	            {return React.createElement("span", null, this.getSection(x));}.bind(this)
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */module.exports = __webpack_require__(170);
